...
interface ChangeOrderClientConfirmedEmailProps {
  designerName: string;
  clientName: string;
  projectName: string;
  cost: string;
...
export const ChangeOrderClientConfirmedEmail = ({
  designerName = "Designer",
  clientName = "Client",
  projectName = "Your Project",
  cost = "0.00",
  orderLink = "#",
}: ChangeOrderClientConfirmedEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Confirmation: Change Order Approved for {projectName}</Preview>
      <Tailwind>
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border-4 border-black border-solid rounded my-[40px] mx-auto p-[20px] max-w-[465px] bg-white shadow-[8px_8px_0px_#000]">
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              This is a confirmation that you have approved the change order for <strong>{projectName}</strong> with <strong>{designerName}</strong>.
            </Text>
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              Your designer has been notified and will proceed with the requested changes. You can view the order details anytime in your project dashboard.
            </Text>
            ...
            <Text className="text-[#666666] text-[12px] leading-[24px]">
              This is an automated confirmation from Challengelog.
            </Text>
          </Container>
        </Body>
      </Tailwind>
...
export default ChangeOrderClientConfirmedEmail;
